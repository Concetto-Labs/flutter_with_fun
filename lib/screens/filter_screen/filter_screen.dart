...
class _FilterScreenState extends State<FilterScreen> {
  ...
  prepareFilterList() {
    ...
    filterList.addAll([
      ...
      FilterImageModel(title: "Brighter", filterColor: ImageFilters.brighter),
      ...
      FilterImageModel(
          title: "Old-Bright", filterColor: ImageFilters.oldBright),
      ...
      FilterImageModel(title: "1977", filterColor: ImageFilters.f1977),
